...
- `app/services/cache.py` — TTL/LRU caches: discovery (~10 min per polygon+type), custom-coordinate resolution (~10 min per point *set*, order-independent), and per-location forecasts (~15 min)
