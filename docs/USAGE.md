...
The Min and Max boxes say which destinations you would consider at all: on AQI, the freezing level, precipitation, temperature and wind, and, under the seam, on elevation. An empty box shows its unit and bounds nothing. **Clear filters** appears as soon as any box holds a number, and it empties every one of them, the results cap included.
