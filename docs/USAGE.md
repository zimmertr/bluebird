...
Every column is resizable: drag the divider at a header's right edge, or double-click it to fit the column to its longest value. Name opens at three quarters of its natural width so more numbers fit on a phone — widen it back whenever a name is cut off. Widths hold for the session.
