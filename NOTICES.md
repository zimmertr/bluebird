...
- [NOAA HMS](https://www.ospo.noaa.gov/Products/land/hms.html): smoke plumes
  ...
  license names Bluebird's use of it. Credited on the map's smoke legend
  whenever smoke is drawn.
- [NOAA HRRR](https://rapidrefresh.noaa.gov/hrrr/): near-surface smoke
  concentration from the High-Resolution Rapid Refresh model, read from the
  [HRRR archive on AWS Open Data](https://registry.opendata.aws/noaa-hrrr-pds/).
  A work of the US government, and so in the public domain under 17 U.S.C. §105;
  no license names Bluebird's use of it. Credited on the map's forecast smoke
  legend whenever that layer is drawn.
- [Iowa Environmental Mesonet](https://mesonet.agron.iastate.edu/ogc/): NEXRAD
  base-reflectivity mosaic tiles, generated by Iowa State University from
  National Weather Service radar data. Served without a license statement and
