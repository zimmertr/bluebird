...
@router.post(
    ...
    description=(
        ...
        "request.\n\n"
        "The HTTP status is **always 200**, including for failures: the "
        "connection is already open and streaming by the time most problems "
        "surface. Check the event stream, not the status code. Four event "
