 ...
 * arm of that table:
 *
 *   - `LEGEND_TOP_PX` is the coarse inset with the Controls button (168), which
 ...
 *   - `LEGEND_TOP_FINE_PX` is the fine inset WITHOUT it (100), which is the
 ...
 */
export const LEGEND_TOP_PX = 168
